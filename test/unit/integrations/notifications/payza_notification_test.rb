...
class PayzaNotificationTest < Test::Unit::TestCase
  ...
  #   assert_equal "", @payza.status
  #   assert_equal "", @payza.transaction_id
  #   assert_equal "", @payza.item_id
  #   assert_equal "", @payza.gross
  #   assert_equal "", @payza.currency
  #   assert_equal "", @payza.received_at
  #   assert @payza.test?
  # end

  # def test_compositions
  #   assert_equal Money.new(3166, 'USD'), @payza.amount
  # end
  ...
  def test_acknowledgement_populate_params_with_result
    ...
    assert_equal "40.00", @payza.gross
